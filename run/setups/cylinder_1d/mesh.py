...
class pyMesh(object):
    def __init__(self, *args):       
        self._r = 0.15 #Cylinder diameter
        self._h = 0.5 #Cylinder height
        self._cellDensity_z = 100 #Cell density in z-direction (cells per meter)
    ...
    def _create_one_level_block_data(self):
        return [
            "hex (0 1 2 3 4 5 6 7) (%i %i %i) " % (1, 1, self._h*self._cellDensity_z) + " simpleGrading (1 1 1)"
        ]
